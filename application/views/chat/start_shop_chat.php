...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Chat with Shop</li>
        </ol>
    </section>
    <script type="text/javascript">
        function saveChat()
        {
            ...
            serverPage = '<?php echo base_url(); ?>evis_chat/save_shop_chat/' + shopId + '/' + adminMessage;
        ...
        function chat()
        {
            ...
            serverPage = '<?php echo base_url(); ?>evis_chat/show_shop_chat/' + shopId;
            xmlhttp.open("GET", serverPage);
            xmlhttp.onreadystatechange = function ()
            {
                document.getElementById('shop_chat_information').innerHTML = xmlhttp.responseText;
