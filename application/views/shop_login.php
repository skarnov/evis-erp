    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>"><b>Evis</b> Shop Area</a>
            </div>
            <div class="login-box-body">
                <form action="<?php echo base_url(); ?>evis_shop_login/shop_login_check" method="POST">
                    ...
                    <div class="form-group has-feedback">
                        <input type="email" name="shop_email" class="form-control" placeholder="Email">
                        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="password" name="shop_password" class="form-control" data-toggle="tooltip" title="Password must be at least six characters" placeholder="Password">
