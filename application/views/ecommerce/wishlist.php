                ...
                <div class="panel panel-info" style="box-shadow: 0px 0px 19px 4px black;">
                    ...
                    if ($select_wishlist == !NULL) {
                        ...
                        <div class="panel-body">
                            ...
                            <hr>
                            <?php
                            foreach ($select_wishlist as $v_contents) {
                                ?>
                                <div class="row" >
                                    <div class="col-xs-1">
                                    ...
                                    <div class="col-xs-2">
                                        <p><p><?php echo $v_contents->price; ?></p></p>
                                    </div>
                                    <div class="col-xs-2">
                                        <p><p><?php echo $v_contents->price; ?></p></p>
                                    </div>
                                    <div class="col-xs-1">
                                        <button class="btn btn-danger" value="">X</button>
                                    </div>
                                </div>
                                <hr>
                            <?php } ?>
                        ...
                        <form action="<?php echo base_url(); ?>evis_pos/save_sale" method="POST" name="cart">
                            <div class="panel-footer">
                                <div class="row text-center">
                                    ...
                                    <div class="col-xs-3">
                                        <h4 class="text-right"> <?php echo $wishlist_total->total;?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer">
